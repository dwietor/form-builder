...
use DWietor\Bundle\CmsFormBundle\Form\Type\ChoiceOptionCollectionType;
use DWietor\Bundle\CmsFormBundle\Form\Type\ChoiceOptionType;
...
class ChoiceFieldExtension extends AbstractTypeExtension
{
    ...
    protected function addFieldsToForm(FormInterface $form, array $choices = []): void
    {
        $choicesOptions = [
            'required'   => false,
            'label'      => 'dwietor.cmsform.cmsformfield.options.choice.choices.label',
            'tooltip'    => 'dwietor.cmsform.cmsformfield.options.choice.choices.tooltip',
            'mapped'     => false,
            'allow_add'  => true,
            'prototype'  => true,
        ...
        $form
            ...
            ->add(
                ...
                [
                    'required'      => false,
                    'label'         => 'dwietor.cmsform.cmsformfield.options.choice.multiple.label',
                    'tooltip'       => 'dwietor.cmsform.cmsformfield.options.choice.multiple.tooltip',
            ...
            ->add(
                ...
                [
                    'required'      => false,
                    'label'         => 'dwietor.cmsform.cmsformfield.options.choice.placeholder.label',
                    'tooltip'       => 'dwietor.cmsform.cmsformfield.options.choice.placeholder.tooltip',
