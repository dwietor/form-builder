...
use DWietor\Bundle\CmsFormBundle\Model\ExtendCmsFieldResponse;
use Doctrine\ORM\Mapping as ORM;
use Oro\Bundle\EntityConfigBundle\Metadata\Annotation\Config;
use Oro\Bundle\EntityConfigBundle\Metadata\Annotation\ConfigField;

/**
 * @ORM\Entity(repositoryClass="DWietor\Bundle\CmsFormBundle\Entity\Repository\CmsFieldResponseRepository")
 * @ORM\Table(name="d_wietor_cms_field_response")
 * @Config(
 *      defaultValues={
 *          "entity"={
