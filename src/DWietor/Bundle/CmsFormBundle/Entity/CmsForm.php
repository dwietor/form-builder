...
use DWietor\Bundle\CmsFormBundle\Helper\SlugifyHelper;
use DWietor\Bundle\CmsFormBundle\Model\ExtendCmsForm;
...
/**
 * @ORM\Entity
 * @ORM\Table(name="d_wietor_cms_form")
 * @Config(
 *      routeName="d_wietor_cms_form_index",
 *      routeView="d_wietor_cms_form_view",
 *      defaultValues={
 *          "entity"={
 *              "icon"="fa-wpforms"
 *          },
 *          "grid"={
 *              "default"="dwietor-cms-forms-grid"
 *          }
 *     }
 * )
