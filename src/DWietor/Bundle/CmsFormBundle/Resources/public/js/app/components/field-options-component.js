    ...
    FieldOptionsComponent = BaseComponent.extend({
        ...
        onFormTypeChanged: function() {
            if (this.selectedFormType !== this.getFormTypeElement().val()) {
                ...
                $.ajax({
                    url: routing.generate('d_wietor_cms_form_frontend_ajax_form_view'),
                    data: data,
                    method: 'POST',
                    ...
                    errorHandlerMessage: __('dwietor.cmsform.ajax.form_view_error')
                });
            }
        },
        ...
        renderPreview: function() {
            ...
            $.ajax({
                url: routing.generate('d_wietor_cms_form_frontend_ajax_field_preview'),
                ...
                errorHandlerMessage: __('dwietor.cmsform.ajax.field_preview_error')
            });
        },
